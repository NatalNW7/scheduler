...
def test_save_batch(job_repository: JobsRepository):
    jobs = [
        Job(url='github.com/test-repo1', branch='test_branch1', scheduled_at=time(22, 0), platform='github'),
        Job(url='github.com/test-repo2', branch='test_branch2', scheduled_at=time(22, 0), platform='github')
    ]
